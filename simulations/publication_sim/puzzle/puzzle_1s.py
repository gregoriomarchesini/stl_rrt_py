...
formula       =  (FOp(30,40) >> p1)  & (FOp(70,80) >> p2) & (GOp(0.01,120) >>  (FOp(0.01,70) >> c_station)) & (GOp(150,160) >> p3)
...
solver_stats = scheduler.optimize_barriers( input_bounds = input_bounds, x_0 = x_0)
