...
box_predicate_1          =  BoxPredicate(dims = [0,1,2],state_dim = 6, size = box_size, center = interest_point_1_center)
visit_time1              = 1000.

interest_point_2_center  = np.array([-100., -100., 0.])
box_predicate_2          =  BoxPredicate(dims = [0,1,2], state_dim = 6,size = box_size, center = interest_point_2_center)
visit_time2               = 2500.

interest_point_4_center  = np.array([0., 0., 100.])
box_predicate_4          =  BoxPredicate(dims = [0,1,2],state_dim = 6, size = box_size, center = interest_point_4_center)
visit_time4              = 3500.

interest_point_3_center  = np.array([100., 100., 0.])
box_predicate_3          =  BoxPredicate(dims = [0,1,2], state_dim = 6,size = box_size, center = interest_point_3_center)
visit_time3              = 5000.
