...
##########################################################
workspace     = Box3d(x = 0,y = 0, z= 0, size = 2*400) 
...
# system and dynamics
##########################################################
system        = SingleIntegrator3d(dt = 0.5) # Example: r0 = 7000 km
max_input     = 100.
...
formula        = (GOp(40.,45.) >> box_predicate_1)  & (FOp(100.,120.) >> box_predicate_2) & (FOp(280.,285.) >> box_predicate_3) 
